...
name: writing-copy
description: >-
  Writes clear, compelling marketing copy for landing pages, product descriptions,
  CTAs, emails, and app UI text. Use when drafting or rewriting homepage sections,
  feature blurbs, button labels, FAQs, empty states, or any user-facing messaging
  where clarity and benefit-led wording matter.
---
