...
export function ConnectWalletButton({
  ...
  return (
    <>
      ...
      {modal.isOpen ? (
        <div
          className="fixed inset-0 z-70 flex items-end justify-center bg-background/80 p-0 sm:items-center sm:p-4"
          role="presentation"
          onClick={() => modal.close()}
        >
          <div
            ...
            className="w-full max-w-sm border-2 border-border bg-card p-4 shadow-lg sm:max-h-[min(80dvh,420px)]"
