...
ALTER TABLE "names" ADD CONSTRAINT "names_publisher_id_publishers_id_fk" FOREIGN KEY ("publisher_id") REFERENCES "public"."publishers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "releases" ADD CONSTRAINT "releases_name_id_names_id_fk" FOREIGN KEY ("name_id") REFERENCES "public"."names"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "manifests_release_id_unique" ON "manifests" USING btree ("release_id");--> statement-breakpoint
CREATE UNIQUE INDEX "names_address_unique" ON "names" USING btree ("address");--> statement-breakpoint
CREATE UNIQUE INDEX "names_name_unique" ON "names" USING btree ("name");--> statement-breakpoint
CREATE INDEX "names_name_trgm_idx" ON "names" USING gin ("name" gin_trgm_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "releases_name_id_version_unique" ON "releases" USING btree ("name_id","version");--> statement-breakpoint
CREATE INDEX "releases_publisher_id_idx" ON "releases" USING btree ("publisher_id");--> statement-breakpoint
CREATE INDEX "releases_name_id_idx" ON "releases" USING btree ("name_id");--> statement-breakpoint
